        ...
        <div  className='container mt-5'>
            <div className='row'>
                ...
                <div className='col-md-6 p-5'>
                    ...
                    <a href='#' style={{textDecoration:"none"}} className='my-3'>Varsity <i className="fa fa-long-arrow-right" aria-hidden="true"></i></a>
                    <br/><br/>
                    ...
                    <a href='#' style={{textDecoration:"none"}} className='mb-5'>TradingQ&A  <i className="fa fa-long-arrow-right" aria-hidden="true"></i></a>
